...
SIGNAL \inst|inst|P7~0_combout\ : std_logic;
SIGNAL \inst|inst3~combout\ : std_logic;
SIGNAL \inst|inst1|P7~0_combout\ : std_logic;
...
\inst|inst|P7~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|inst|P7~0_combout\ = (\A1~combout\ & (((\A0~combout\ & !\B0~combout\)) # (!\B1~combout\))) # (!\A1~combout\ & (!\B1~combout\ & (\A0~combout\ & !\B0~combout\)))
...
PORT MAP (
	...
	datac => \A0~combout\,
	datad => \B0~combout\,
	combout => \inst|inst|P7~0_combout\);

-- Location: LCCOMB_X49_Y7_N18
\inst|inst3\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|inst3~combout\ = (\A1~combout\ & ((\A0~combout\ $ (\B0~combout\)) # (!\B1~combout\))) # (!\A1~combout\ & ((\B1~combout\) # (\A0~combout\ $ (\B0~combout\))))
...
\inst|inst1|P7~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \inst|inst1|P7~0_combout\ = (\A1~combout\ & (\B1~combout\ & (!\A0~combout\ & \B0~combout\))) # (!\A1~combout\ & ((\B1~combout\) # ((!\A0~combout\ & \B0~combout\))))
...
PORT MAP (
	...
	datac => \A0~combout\,
	datad => \B0~combout\,
	combout => \inst|inst1|P7~0_combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \inst|ALT_INV_inst3~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
...
-- pragma translate_on
PORT MAP (
	datain => \inst|inst1|P7~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	devoe => ww_devoe,
	oe => VCC,
